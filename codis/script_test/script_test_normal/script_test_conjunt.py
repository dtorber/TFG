...
if __name__ == "__main__":
    ...
    script_test_sense_generar.main(checkpoint= "NASca-finetuned-de-zero-amb-metriques-anonim", eixida = "resultats_script_test_de_zero.out")
    #se comprova si canvia algo quan li donem la font correcta
    script_test_font_correcta_sense_generar.main(checkpoint= "NASca-finetuned-de-zero-amb-metriques-anonim", eixida = "resultats_script_test_font_correcta_de_zero.out")
    ...
    script_test_fonts_ampliat_sense_generar.main(checkpoint= "NASca-finetuned-de-zero-amb-metriques-anonim", eixida = "resultats_script_test_fonts_ampliat_de_zero.out") 
    #se comprova si en algun cas quan forcem el token canvia el resum o no i quant canvia
    script_test_fonts_ampliat_matrius_sense_generar.main(checkpoint= "NASca-finetuned-de-zero-amb-metriques-anonim", eixida = "resultats_script_test_fonts_ampliat_matrius_de_zero.out")     