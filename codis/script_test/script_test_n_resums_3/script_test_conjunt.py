...
if __name__ == "__main__":
    ...
    script_test_sense_generar.main(checkpoint= "NASca-finetuned-de-zero-amb-metriques-anonim", eixida = "../resultats_n_resums/resultats_script_test_de_zero.out")
    #se comprova si canvia algo quan li donem la font correcta
    script_test_font_correcta_sense_generar.main(checkpoint= "NASca-finetuned-de-zero-amb-metriques-anonim", eixida = "../resultats_n_resums/resultats_script_test_font_correcta_de_zero.out")
